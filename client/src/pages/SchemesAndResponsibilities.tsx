...
const SchemesAndResponsibilities = () => {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2">Schemes & Responsibilities</h1>
        <p className="text-neutral-medium">
          Explore government schemes available to citizens and businesses, and understand your legal responsibilities
        </p>
      </div>
      ...
      <Tabs defaultValue="schemes" className="w-full" onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2 mb-6">
          ...
          <TabsTrigger value="responsibilities">Citizen Responsibilities</TabsTrigger>
        </TabsList>
              ...
              {selectedScheme ? (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>{selectedScheme.title}</CardDescription>
                  </CardHeader>
                  ...
                  <CardFooter className="flex justify-between">
                    <Button className="w-full" variant="default">
                      <a href={selectedScheme.url} target="_blank" rel="noopener noreferrer" className="flex items-center">
                        Apply Now
                      </a>
                    </Button>
                  </CardFooter>
                ...
                <Card>
                  ...
                  <CardContent className="text-center py-10">
                    ...
                    <p className="text-neutral-medium">Click on any scheme from the list to view its eligibility criteria, benefits, and application process</p>
                  </CardContent>
                </Card>
              )}
              ...
              <Card>
                <CardContent className="p-4">
                  {filteredResponsibilities.length > 0 ? (
                    ...
                    <div className="py-10 text-center">
                      <Info className="mx-auto h-10 w-10 text-neutral-medium mb-4" />
                      <h3 className="text-lg font-medium">No responsibilities found</h3>
                      <p className="text-neutral-medium">Try adjusting your search or filters</p>
                    </div>
                  )}
                </CardContent>
              ...
              {selectedResponsibility ? (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>{selectedResponsibility.title}</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <h4 className="text-sm font-medium mb-1">Description</h4>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Responsibility Details</CardTitle>
                    <CardDescription>Select a responsibility to view details</CardDescription>
                  </CardHeader>
                  <CardContent className="text-center py-10">
                    <Info className="mx-auto h-12 w-12 text-neutral-medium mb-4" />
                    <p className="text-neutral-medium">Click on any responsibility from the list to view detailed requirements, deadlines, and compliance information</p>
                  </CardContent>
                </Card>
              )}
      ...
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-4">Transportation Responsibilities by Type</h2>
